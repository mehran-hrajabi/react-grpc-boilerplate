...
export function map(elts: any, f: any) {
	const apply = (appElts: any) =>
		Promise.all(
			appElts.map((elt: any) => (typeof elt.then === 'function' ? elt.then(f) : f(elt))),
		);
...
export function _try<T>(
	f: (arg: any, arg2: any, arg3: any) => T,
	arg: any,
	arg2: any,
	arg3: any,
): Promise<T>;
export function _try<T>(
	f: (arg: any, arg2: any, arg3: any, arg4: any) => T,
	arg: any,
	arg2: any,
	arg3: any,
	arg4: any,
